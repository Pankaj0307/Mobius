...
public class SlabWageAdapter extends RecyclerView.Adapter<SlabWageAdapter.ViewHolder> {

    private List<DataModel.Slabs> dataModelList;
    private Context context;

    public SlabWageAdapter(Context context, List<DataModel.Slabs> slabs) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (slab != null) {
            String percentage = String.valueOf(slab.getWagered_percent()) + "%";
            StringBuilder sb = new StringBuilder();
            sb.append(percentage);
            sb.append("(Max. ");
            String max_amount = context.getResources().getString(R.string.rs) + slab.getWagered_max();
